...
namespace Ched.Components.Exporter
{
    public class SusExporter
    {
        ...
        public void Export(Stream stream)
        {
            ...
            {
                writer.WriteLine("This file was generated by ChedPlus {0}.", System.Reflection.Assembly.GetEntryAssembly().GetName().Version.ToString());
                writer.WriteLine("Ched available from https://github.com/paralleltree/Ched");
                writer.WriteLine("ChedPlus available from https://github.com/4yn/Ched");
                writer.WriteLine("ChedPlus available from https://github.com/LittleYang0531/ChedPlus");
